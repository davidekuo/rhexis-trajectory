...
def main():
    ...
    R50_dataset1000_augment_AP, R50_dataset1000_augment_loss = json2dataframes(
        R50_dataset1000_augment
    )
    ...
    R101_dataset1000_augment_AP, R101_dataset1000_augment_loss = json2dataframes(
        R101_dataset1000_augment
    )
    ...
    X101_dataset1000_augment_AP, X101_dataset1000_augment_loss = json2dataframes(
        X101_dataset1000_augment
    )

    # Generate plots
    all_data = [
        (R50_dataset1000_AP, R50_dataset1000_loss, "R50 without augmentation"),
        (
            R50_dataset1000_augment_AP,
            R50_dataset1000_augment_loss,
            "R50 with augmentation",
        ),
        (R101_dataset1000_AP, R101_dataset1000_loss, "R101 without augmentation"),
        (
            R101_dataset1000_augment_AP,
            R101_dataset1000_augment_loss,
            "R101 with augmentation",
        ),
        (X101_dataset1000_AP, X101_dataset1000_loss, "X101 without augmentation"),
        (
            X101_dataset1000_augment_AP,
            X101_dataset1000_augment_loss,
            "X101 with augmentation",
        ),
    ]
