...
def main():
    parser = argparse.ArgumentParser(description = "Extracts frames of filename.mp4 into output directory with JPEGs named filename_frame#.jpg. Default output directory is [input file directory]/[filename]")
    ...
    print(f"input directory: {input_dir} | output directory: {output_dir} | filename: {filename}")
