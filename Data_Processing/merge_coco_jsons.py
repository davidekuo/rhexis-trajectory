...
def main():
    parser = argparse.ArgumentParser(description = "Merges keypoint and bounding box annotation JSONs.")
    parser.add_argument('keypoint_path', type=str, help='path to keypoint annotation JSON')
    parser.add_argument('bbox_path', type=str, help='path to bounding box annotation JSON')
    ...
    imageid2keypoints = {annot['image_id']: annot['keypoints'] for annot in keypoints['annotations']}
